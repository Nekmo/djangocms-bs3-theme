...
PACKAGE_NAME = 'djangocms-bs3-theme'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/djangocms-bs3-theme/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/djangocms-bs3-theme'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['djangocms', 'django', 'cms', 'bs3', 'boostrap', 'boostrap3', 'theme', 'themes', 'styles', 'templates']  #
# Palabras
# clave
...
DESCRIPTION = """\
Boostrap3 Themes for Django CMS.
"""
